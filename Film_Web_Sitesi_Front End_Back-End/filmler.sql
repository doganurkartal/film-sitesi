...
(26, 509, 153, 909, 110, 103, '2021-07-08', 'Sivas'),
(27, 509, 153, 909, 129, 103, '2021-07-08', 'Sivas'),
(28, 509, 153, 909, 134, 103, '2021-07-08', 'Sivas'),
(29, 509, 153, 909, 136, 103, '2021-07-08', 'Sivas'),
...
(46, 508, 170, 907, 134, 103, '2021-07-30', 'Ankara'),
(47, 508, 164, 904, 115, 102, '2021-06-26', 'Istanbul'),
(48, 508, 168, 906, 121, 105, '2021-06-18', 'Balikesir'),
(49, 508, 168, 906, 122, 105, '2021-06-18', 'Balikesir'),
(50, 508, 168, 906, 123, 105, '2021-06-18', 'Balikesir');
...
(506, 'The Godfather: Part II', '2010-01-19', 'Genc Corleone, AmerikaÃ¢ÂÂya yeni gelmistir. 1917 yilinda, New York sehriÃ¢ÂÂnin yerel mafyalarindan birinin liderini oldurunce sayginlik kazanir ve korkulan biri haline gelir. Bu arada, 50 yil sonra, Michael Corleone, WashingtonÃ¢ÂÂda senato komitesine aile isleriyle ilgili ifade vermektedir.', '9.0', 12, 31, 81, 93, 'https://m.media-amazon.com/images/M/MV5BMWMwMGQzZTItY2JlNC00OWZiLWIyMDctNDk2ZDQ2YjRjMWQ0XkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_.jpg', 'https://www.youtube.com/embed/9O1Iy9od7-A'),
(507, 'Schindler\'s List', '2019-10-16', 'SchindlerÃ¢ÂÂin Listesi, Oskar Schindler adli bir Alman isadaminin 2. Dunya Savasi zamaninda PolonyaÃ¢ÂÂda kurdugu fabrikada Yahudi iscileri calistirmasi ve bu sayede 1100 YahudiÃ¢ÂÂnin hayatini kurtarmasini konu aliyor.', '8.9', 13, 36, 87, 93, 'https://upload.wikimedia.org/wikipedia/tr/3/38/Schindler%27s_List_movie.jpg', 'https://www.youtube.com/embed/gG22XNhtnoY'),
(508, 'Inception', '2022-02-11', 'Dom Cobb (Leonardo DiCaprio) cok yetenekli bir hirsizdir. Uzmanlik alani, zihnin en savunmasiz oldugu ruya gorme aninda, bilincaltinin derinliklerindeki degerli sirlari cekip cikarmak ve onlari calmaktir. CobbÃ¢ÂÂun bu ender mahareti, onu kurumsal casuslugun tehlikeli yeni dunyasinda aranan bir oyuncu yapmistir. Ancak, ayni zamanda bu durum onu uluslararasi bir kacak yapmis ve sevdigi herseye malolmustur. CobbÃ¢ÂÂa icinde bulundugu durumdan kurtulmasini saglayacak bir firsat sunulur. Ona hayatini geri verebilecek son bir is; tabi eger imkansiz Ã¢ÂÂbaslangicÃ¢ÂÂi tamamlayabilirse. Mukemmel soygun yerine, Cobb ve takimindaki profesyoneller bu sefer tam tersini yapmak zorundadir; gorevleri bir fikri calmak degil onu yerlestirmektir. Eger basarirlarsa, mukemmel suc bu olacaktir. Ama ne dikkatle yapilan planlamalar, ne de uzmanliklari, onlari, her hareketlerini onceden tahmin ettigi anlasilan tehlikeli dusmanlarina karsi hazirlikli kilabilir. Bu, gelisini sadece CobbÃ¢ÂÂun gorebildigi bir dusmandir.', '8.8', 24, 32, 89, 92, 'https://flxt.tmsimg.com/assets/p7825626_p_v10_af.jpg', 'https://www.youtube.com/embed/8hP9D6kZseM'),
(509, 'The Shawshank Redemption', '2022-02-11', 'Genc ve basarili bir banker olan Andy Dufresne, karisini ve onun sevgilisini oldurmek sucundan omur boyu hapse mahkum edilir ve Shawshank hapishanesine gonderilir. Iskence, tecavuz, dayak dahil her turlu kotu kosulun hukum surdugu hapishane kosullarinda, Andynin hayata bagli ve her daim iyi bir seyler bulma cabasi icindeki hali, cevresindeki herkesi cok etkileyecektir. Bir sure sonra parmakliklarin arkasinda bile ozgur bir yasam olabilecegine butun mahkumlari inandirir. Bu mahkumlardan biri olan Red ve Andy, unutulmaz bir dostluk kurarak hapishaneyi bambaska bir yer haline getirirler.', '9.3', 14, 30, 80, 93, 'https://m.media-amazon.com/images/M/MV5BMDFkYTc0MGEtZmNhMC00ZDIzLWFmNTEtODM1ZmRlYWMwMWFmXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_UY1200_CR89,0,630,1200_AL_.jpg', 'https://www.youtube.com/embed/P9mwtI82k6E'),
...
--
-- Dumping data for table `film_oyuncu`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=3008 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
--
-- Table structure for table `salon_seans`
--
...
--
-- Dumping data for table `salon_seans`
--
...
(100, 'Ecemur', 'Ozkan', 'ecemur01@gmail.com', 'ecemur123', 12345, '2015-08-15'),
(101, 'Erva', 'Yalcin', 'erva123@gmail.com', 'erva123', 12346, '2020-12-22'),
(102, 'Kadir', 'Sahin', 'kadir123@gmail.com', 'kadir123', 23456, '2018-10-19'),
(103, 'Doga', 'Kartal', 'doga123@gmail.com', 'doga123', 34567, '2019-11-14'),
(104, 'Duygu', 'Bahar', 'duygu123@gmail.com', 'duygu123', 45678, '2017-01-25'),
(105, 'Hazel', 'TAS', 'HazelTas@gmail.com', 'ba3253876aed6bc22d4a6ff53d8406c6ad864195ed144ab5c87621b6c233b548baeae6956df346ec8c17f5ea10f35ee3cbc514797ed7ddd3145464e2a0bab413', 1111111111, '2001-08-30'),
(106, 'denemeeeeeeeee', 'asdassdasdad', 'abcde@gmail.com', 'ba3253876aed6bc22d4a6ff53d8406c6ad864195ed144ab5c87621b6c233b548baeae6956df346ec8c17f5ea10f35ee3cbc514797ed7ddd3145464e2a0bab413', 1111111111, '2002-06-01'),
(107, 'admin', 'admin', 'admin@gmail.com', 'c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec', 3444444444, '1997-05-06');

-- --------------------------------------------------------

--
-- Table structure for table `yapim`
--
...
--
-- Table structure for table `yapim_yeri`
--
...
--
-- Dumping data for table `yapim_yeri`
--
...
CREATE TABLE IF NOT EXISTS `yorum` (
  ...
  KEY `film_ID` (`film_ID`),
  KEY `film_ID_2` (`film_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2006 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;

--
-- Dumping data for table `yorum`
--

INSERT INTO `yorum` (`yorum_ID`, `yorum`, `uye_ID`, `begeni`, `film_ID`) VALUES
(2000, 'Cok guzel bir film.', 101, 150, 505),
(2001, 'Nefret ettim.', 102, 202, 505),
(2002, 'Abiii cok iyi.', 100, 76, 502),
(2003, 'Hem guzel hem degil karar veremedim.', 104, 53, 502),
(2004, 'Guzel ama ne guzel anlatamam.', 103, 65, 509),
(2005, 'Abi rezaletti yaaa.', 100, 101, 501);
...
--
-- Constraints for table `film_oyuncu`
--
...
--
-- Constraints for table `salon_seans`
--
